...
export const SidebarItem = forwardRef(function SidebarItem(
  ...
  let classes = clsx(
    ...
    // Leading icon/icon-only - reduced size from size-6 to size-4
    '*:data-[slot=icon]:size-4 *:data-[slot=icon]:shrink-0 *:data-[slot=icon]:fill-zinc-500 sm:*:data-[slot=icon]:size-4',
