...
- Poster cards can use low-opacity runner cutouts as deterministic-random background texture. Choose run/stride poses for faster running periods and walk/stretch/lifestyle poses for walk-like or slow periods; keep the background figure subtle in the lower-right third so route data remains primary.
