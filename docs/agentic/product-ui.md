...
- Favorite-runner visuals are generated low-poly character cutouts under `apps/web/public/assets/runners/`. Use them sparingly as transparent background accents in dashboard/poster surfaces; they should support the route-atlas mood without replacing data views or map/route visuals.
