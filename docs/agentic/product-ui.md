...
- Favorite-runner visuals are generated low-poly character cutouts under `apps/web/public/assets/runners/`. Keep them contained inside dedicated runner-muse panels or similarly bounded slots; do not overlay route glyphs, poster cards, metric rows, hero text, or primary data surfaces.
